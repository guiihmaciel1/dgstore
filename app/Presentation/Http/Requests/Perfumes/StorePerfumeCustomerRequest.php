...
class StorePerfumeCustomerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'phone'      => ['required', 'string', 'min:10', 'max:11', 'unique:perfume_customers,phone'],
            'cpf'        => ['nullable', 'string', 'size:11', 'unique:perfume_customers,cpf'],
