...
class StoreSaleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'items.*.financial_cost' => ['nullable', 'numeric', 'min:0'],
            'items.*.commission_cost' => ['nullable', 'numeric', 'min:0'],
    ...
    public function attributes(): array
    {
        return [
            ...
            'seller_name' => 'vendedor responsável',
            ...
            'items.*.financial_cost' => 'custo financeiro',
            'items.*.commission_cost' => 'custo comissão',
            ...
            'trade_ins.*.category' => 'categoria do aparelho',
            'trade_ins.*.storage' => 'armazenamento do aparelho',
