        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" x-data="payablesPage()">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                ...
                <div style="background: white; border-radius: 0.75rem; padding: 1.25rem; border: 1px solid #e5e7eb;">
                    ...
                    <div style="font-size: 0.625rem; color: #9ca3af; margin-top: 0.25rem;">Total pago no período filtrado</div>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mt-4">
                        ...
                        <div>
                            ...
                            <template x-if="installments > 1">
                                <span style="font-size: 0.625rem; color: #9ca3af;">Parcelado = pagar individualmente</span>
                            </template>
                        </div>
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 items-end">
                        ...
                        <div class="flex gap-2">
                            ...
                            @if(array_filter($filters))
                                <a href="{{ route('finance.payables') }}" style="padding: 0.375rem 0.75rem; background: white; color: #374151; font-weight: 500; border-radius: 0.375rem; border: 1px solid #d1d5db; text-decoration: none; font-size: 0.8125rem; display: flex; align-items: center;">Limpar</a>
                            @endif
                        </div>
                    </div>
                </form>
