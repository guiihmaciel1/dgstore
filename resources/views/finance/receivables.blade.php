                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 items-end">
                        ...
                        <div class="flex gap-2">
                            ...
                            @if(array_filter($filters))
                                <a href="{{ route('finance.receivables') }}" style="padding: 0.375rem 0.75rem; background: white; color: #374151; font-weight: 500; border-radius: 0.375rem; border: 1px solid #d1d5db; text-decoration: none; font-size: 0.8125rem; display: flex; align-items: center;">Limpar</a>
                            @endif
                        </div>
                    </div>
                </form>
