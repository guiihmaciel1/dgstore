        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" x-data="receivablesPage()">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                <div style="background: white; border-radius: 0.75rem; padding: 1.25rem; border: 1px solid #e5e7eb;">
                    <div style="font-size: 0.6875rem; text-transform: uppercase; font-weight: 600; color: #d97706;">A Receber</div>
                ...
                <div style="background: white; border-radius: 0.75rem; padding: 1.25rem; border: 1px solid {{ $summary['overdue'] > 0 ? '#fecaca' : '#e5e7eb' }};">
                    <div style="font-size: 0.6875rem; text-transform: uppercase; font-weight: 600; color: #dc2626;">Atrasado</div>
                    <div style="font-size: 1.5rem; font-weight: 800; color: #dc2626; margin-top: 0.25rem;">R$ {{ number_format($summary['overdue'], 2, ',', '.') }}</div>
                </div>
                <div style="background: white; border-radius: 0.75rem; padding: 1.25rem; border: 1px solid #e5e7eb;">
                    <div style="font-size: 0.6875rem; text-transform: uppercase; font-weight: 600; color: #16a34a;">Recebido no Mês</div>
                    <div style="font-size: 1.5rem; font-weight: 800; color: #16a34a; margin-top: 0.25rem;">R$ {{ number_format($summary['receivedThisMonth'], 2, ',', '.') }}</div>
                </div>
            </div>
