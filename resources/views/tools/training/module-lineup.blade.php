...
<div style="background: #141414; border: 1px solid rgba(255,255,255,0.06); border-radius: 0.75rem; overflow: hidden;">
    <button @click="toggleModule('lineup')" type="button"
        ...
        <div style="display: flex; align-items: center; gap: 0.75rem;">
            ...
            <div>
                <span style="font-size: 1rem; font-weight: 700; color: #e3e3e3;">Lineup 2025 — Conhece a Família!</span>
                <div style="font-size: 0.75rem; color: #666666;">Os modelos novos que a gente vende</div>
            </div>
        </div>
        <div style="display: flex; align-items: center; gap: 0.5rem;">
            <span x-show="readModules.includes('lineup')" style="font-size: 0.6875rem; font-weight: 600; color: #059669; background: rgba(16,185,129,0.1); padding: 2px 8px; border-radius: 9999px;">✓ lido</span>
            <svg width="16" height="16" :style="openModule === 'lineup' ? 'transform:rotate(180deg);' : ''" style="flex-shrink:0; color: #666666; transition: transform 0.2s;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div x-show="openModule === 'lineup'" x-transition style="border-top: 1px solid #f3f4f6; padding: 1.25rem;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 0.75rem;">
            <template x-for="phone in lineup2025" :key="phone.name">
                <div style="border: 1px solid rgba(255,255,255,0.06); border-radius: 0.75rem; overflow: hidden; transition: transform 0.15s, box-shadow 0.15s;"
                    ...
                    <div style="padding: 1rem;">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 0.375rem; font-size: 0.8rem; color: #818181;">
                        ...
                        <div style="margin-top: 0.75rem; padding-top: 0.625rem; border-top: 1px solid #f3f4f6;">
                            <p style="font-size: 0.75rem; color: #e3e3e3; font-weight: 600;" x-text="'💡 ' + phone.sellTip"></p>
                        </div>
                    </div>
                </div>
            </template>
        ...
        <div style="margin-top: 1rem; background: rgba(245,158,11,0.1); border: 1px solid #fef08a; border-radius: 0.5rem; padding: 0.75rem 1rem;">
            <p style="font-size: 0.8rem; color: #fbbf24; font-weight: 600;">💡 Dica de ouro:</p>
            <p style="font-size: 0.8rem; color: #fbbf24; margin-top: 0.25rem;">Sempre pergunte pro cliente o que ele mais usa no celular. Quem curte foto? Pro Max. Quer algo leve? iPhone Air. Não quer gastar muito? 16e é perfeito.</p>
        </div>
    </div>
</div>
