{{-- Highlighted sections: Mais Vendidos + Mais Procurados --}}
@if($bestSellers->isNotEmpty() || $mostWanted->isNotEmpty())
    ...
    @if($bestSellers->isNotEmpty())
        <section class="animate-fade-up" style="animation-delay: 0.1s;">
            ...
            <div class="relative -mx-5 px-5 sm:mx-0 sm:px-0">
                <div class="flex gap-3.5 sm:gap-4 overflow-x-auto hide-scrollbar pb-2 snap-x snap-mandatory">
