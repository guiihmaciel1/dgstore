<x-app-layout>
    <x-slot name="title">Detalhes da Garantia</x-slot>
    <div class="py-4">
        <div class="px-6 lg:px-8">
            ...
            <div style="display: flex; align-items: center; margin-bottom: 1.5rem;">
                <a href="{{ route('warranties.index') }}" style="margin-right: 1rem; padding: 0.5rem; color: #818181; border-radius: 0.5rem;"
                ...
                <div style="flex: 1;">
                    <h1 style="font-size: 1.5rem; font-weight: 700; color: #e3e3e3;">Detalhes da Garantia</h1>
                    <p style="font-size: 0.875rem; color: #818181;">{{ $warranty->product_name }}</p>
                </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                    ...
                    <div style="padding: 1.25rem;">
                        <dl style="display: flex; flex-direction: column; gap: 1rem;">
                            <div>
                                ...
                                <dd style="margin-top: 0.25rem; font-weight: 500; color: #e3e3e3;">{{ $warranty->saleItem?->product?->full_name ?? $warranty->product_name }}</dd>
                            </div>
                            @if($warranty->imei)
                            <div>
                                <dt style="font-size: 0.75rem; font-weight: 500; color: #818181; text-transform: uppercase;">IMEI/Serial</dt>
                                <dd style="margin-top: 0.25rem; font-family: monospace; color: #e3e3e3;">{{ $warranty->imei }}</dd>
                            </div>
                            @endif
                            <div>
                                <dt style="font-size: 0.75rem; font-weight: 500; color: #818181; text-transform: uppercase;">Venda</dt>
                            ...
                            <div>
                                ...
                                <dd style="margin-top: 0.25rem; color: #e3e3e3;">{{ $warranty->saleItem?->sale?->sold_at?->format('d/m/Y') }}</dd>
                            </div>
                            <div>
                                <dt style="font-size: 0.75rem; font-weight: 500; color: #818181; text-transform: uppercase;">Cliente</dt>
                                <dd style="margin-top: 0.25rem; color: #e3e3e3;">{{ $warranty->customer_name ?? 'Não informado' }}</dd>
                            </div>
                        </dl>
                    </div>
                </div>
                ...
                <div style="background: #141414; border-radius: 0.75rem; border: 1px solid rgba(255,255,255,0.06); overflow: hidden;">
                    <div style="padding: 1rem; border-bottom: 1px solid rgba(255,255,255,0.06);">
                        <h3 style="font-weight: 600; color: #e3e3e3;">Status das Garantias</h3>
                    </div>
                    <div style="padding: 1.25rem;">
                        <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                            <!-- Garantia Fornecedor -->
                            <div style="padding: 1rem; background: #1a1a1a; border-radius: 0.5rem;">
                                <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 0.75rem;">
                                    <div>
                                        <p style="font-size: 0.75rem; font-weight: 600; color: #818181; text-transform: uppercase;">Garantia do Fornecedor</p>
                                        <p style="font-size: 0.875rem; color: #a4a4a4;">{{ $warranty->supplier_warranty_months }} meses</p>
                                    </div>
                                ...
                                @if($warranty->supplier_warranty_until)
                                    <div style="display: flex; justify-content: space-between; font-size: 0.875rem;">
                                        <span style="color: #818181;">Válida até:</span>
                                        <span style="font-weight: 500; color: #e3e3e3;">{{ $warranty->supplier_warranty_until->format('d/m/Y') }}</span>
                                    </div>
                                    @if($warranty->is_supplier_warranty_active)
                                        <div style="display: flex; justify-content: space-between; font-size: 0.875rem; margin-top: 0.25rem;">
                                            <span style="color: #818181;">Dias restantes:</span>
                                            <span style="font-weight: 500; color: {{ $daysRemaining <= 30 ? '#d97706' : '#16a34a' }};">{{ $daysRemaining }} dias</span>
                                        </div>
                                    @endif
                                @else
                                    <p style="font-size: 0.875rem; color: #666666;">Não definida</p>
                                @endif
                            </div>
                            ...
                            <div style="padding: 1rem; background: #1a1a1a; border-radius: 0.5rem;">
                                <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 0.75rem;">
                                    <div>
                                        <p style="font-size: 0.75rem; font-weight: 600; color: #818181; text-transform: uppercase;">Garantia para o Cliente</p>
                                        <p style="font-size: 0.875rem; color: #a4a4a4;">{{ $warranty->customer_warranty_months }} meses</p>
                                    </div>
                                ...
                                @if($warranty->customer_warranty_until)
                                    <div style="display: flex; justify-content: space-between; font-size: 0.875rem;">
                                        <span style="color: #818181;">Válida até:</span>
                                        <span style="font-weight: 500; color: #e3e3e3;">{{ $warranty->customer_warranty_until->format('d/m/Y') }}</span>
                                    </div>
            ...
            <div style="background: #141414; border-radius: 0.75rem; border: 1px solid rgba(255,255,255,0.06); overflow: hidden; margin-top: 1.5rem;">
                <div style="padding: 1rem; background: #fef3c7; border-bottom: 1px solid #fde68a;">
                    <h3 style="font-weight: 600; color: #fbbf24;">Registrar Acionamento de Garantia</h3>
                </div>
                <div style="padding: 1.25rem;">
                    <form method="POST" action="{{ route('warranties.claims.store', $warranty) }}">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 2fr; gap: 1rem; align-items: start;">
                            <div>
                                <label style="display: block; font-size: 0.875rem; font-weight: 500; color: #a4a4a4; margin-bottom: 0.5rem;">Tipo de Acionamento</label>
                                <select name="type" required style="width: 100%; padding: 0.625rem 0.75rem; border: 2px solid rgba(255,255,255,0.08); border-radius: 0.5rem; font-size: 0.875rem; background: #141414;">
                            ...
                            <div>
                                <label style="display: block; font-size: 0.875rem; font-weight: 500; color: #a4a4a4; margin-bottom: 0.5rem;">Motivo do Acionamento</label>
                                <textarea name="reason" required rows="2" placeholder="Descreva o problema relatado..."
                                          style="width: 100%; padding: 0.625rem 0.75rem; border: 2px solid rgba(255,255,255,0.08); border-radius: 0.5rem; font-size: 0.875rem; resize: vertical;"></textarea>
                            </div>
                        </div>
            ...
            <div style="background: #141414; border-radius: 0.75rem; border: 1px solid rgba(255,255,255,0.06); overflow: hidden; margin-top: 1.5rem;">
                <div style="padding: 1rem; border-bottom: 1px solid rgba(255,255,255,0.06);">
                    <h3 style="font-weight: 600; color: #e3e3e3;">Histórico de Acionamentos</h3>
                </div>
                ...
                @else
                    <div style="divide-y divide-border;">
                        @foreach($warranty->claims->sortByDesc('opened_at') as $claim)
                            <div style="padding: 1.25rem; border-bottom: 1px solid rgba(255,255,255,0.04);">
                                <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 0.75rem;">
                                    ...
                                    <span style="font-size: 0.75rem; color: #818181;">{{ $claim->opened_at->format('d/m/Y H:i') }}</span>
                                </div>
                                
                                <div style="margin-bottom: 0.75rem;">
                                    <p style="font-size: 0.75rem; font-weight: 500; color: #818181;">Motivo:</p>
                                    <p style="font-size: 0.875rem; color: #a4a4a4;">{{ $claim->reason }}</p>
                                </div>

                                @if($claim->resolution)
                                    <div style="margin-bottom: 0.75rem; padding: 0.75rem; background: #1a1a1a; border-radius: 0.375rem;">
                                        <p style="font-size: 0.75rem; font-weight: 500; color: #818181;">Resolução:</p>
                                        <p style="font-size: 0.875rem; color: #a4a4a4;">{{ $claim->resolution }}</p>
                                    </div>
                                @endif

                                <div style="display: flex; justify-content: space-between; align-items: center; font-size: 0.75rem; color: #818181;">
                                    ...
                                    <div style="margin-top: 1rem; padding-top: 1rem; border-top: 1px solid rgba(255,255,255,0.06);">
                                        <form method="POST" action="{{ route('warranties.claims.update', $claim) }}" style="display: flex; gap: 0.75rem; flex-wrap: wrap; align-items: flex-end;">
                                            ...
                                            <div style="min-width: 150px;">
                                                <label style="display: block; font-size: 0.75rem; color: #818181; margin-bottom: 0.25rem;">Status</label>
                                                <select name="status" style="width: 100%; padding: 0.375rem 0.5rem; border: 1px solid rgba(255,255,255,0.08); border-radius: 0.375rem; font-size: 0.75rem; background: #141414;">
                                            ...
                                            <div style="flex: 1; min-width: 200px;">
                                                <label style="display: block; font-size: 0.75rem; color: #818181; margin-bottom: 0.25rem;">Resolução</label>
                                                <input type="text" name="resolution" placeholder="Descreva a resolução..."
                                                       style="width: 100%; padding: 0.375rem 0.5rem; border: 1px solid rgba(255,255,255,0.08); border-radius: 0.375rem; font-size: 0.75rem;">
                                            </div>
            ...
            <div style="background: #141414; border-radius: 0.75rem; border: 1px solid rgba(255,255,255,0.06); overflow: hidden; margin-top: 1.5rem;">
                ...
                <div style="padding: 1.25rem;">
                    <p style="font-size: 0.875rem; color: #a4a4a4; white-space: pre-line;">{{ $warranty->notes }}</p>
                </div>
            </div>
            @endif
        </div>
