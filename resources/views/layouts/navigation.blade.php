                ...
                <div class="hidden sm:-my-px sm:ms-6 sm:flex items-center gap-0.5">
                    ...
                    <div class="relative">
                        ...
                        <div x-show="commercialOpen" 
                            ...
                            <div class="py-1">
                                ...
                                <a href="{{ route('purchase-requests.index') }}" class="flex items-center px-4 py-2.5 text-sm {{ request()->routeIs('purchase-requests.*') ? 'text-white bg-surface-elevated' : 'text-dg-300 hover:text-white hover:bg-surface-elevated' }}">
                                    <svg class="w-4 h-4 mr-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="relative">
                        <button @click="stockOpen = !stockOpen; commercialOpen = false; financeOpen = false; toolsOpen = false" 
                                class="inline-flex items-center px-3 py-2 text-sm font-medium rounded-lg transition {{ request()->routeIs('products.*') || request()->routeIs('stock.*') || request()->routeIs('stock.consignment.*') || request()->routeIs('imports.*') || request()->routeIs('fragrances.*') ? 'text-white bg-surface-overlay' : 'text-dg-300 hover:text-white hover:bg-surface-overlay' }}">
                            <span>Estoque</span>
                        ...
                        <div x-show="stockOpen" 
                            ...
                            <div class="py-1">
                                ...
                                @endif
                                <a href="{{ route('fragrances.index') }}" class="flex items-center px-4 py-2.5 text-sm {{ request()->routeIs('fragrances.*') ? 'text-white bg-surface-elevated' : 'text-dg-300 hover:text-white hover:bg-surface-elevated' }}">
                                    <svg class="w-4 h-4 mr-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {{-- B2B button hidden from top nav --}}
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-surface-overlay">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div class="border-t border-border mt-2 pt-2">
                ...
                <a href="{{ route('purchase-requests.index') }}" class="block px-6 py-2 text-base font-medium {{ request()->routeIs('purchase-requests.*') ? 'text-white bg-surface' : 'text-dg-300 hover:text-white hover:bg-surface-elevated' }}">
                    Solic. Compra
                </a>
            ...
            <div class="border-t border-border mt-2 pt-2">
                ...
                @endif
                <a href="{{ route('fragrances.index') }}" class="block px-6 py-2 text-base font-medium {{ request()->routeIs('fragrances.*') ? 'text-white bg-surface' : 'text-dg-300 hover:text-white hover:bg-surface-elevated' }}">
                    Perfumaria
                </a>
            </div>
