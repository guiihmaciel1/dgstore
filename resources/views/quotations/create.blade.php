<x-app-layout>
    <x-slot name="title">Nova Cotação</x-slot>
    <div class="py-4">
        <div class="px-6 lg:px-8">
            <!-- Cabeçalho compacto -->
            <div style="display: flex; align-items: center; margin-bottom: 1rem;">
                <a href="{{ route('quotations.index') }}" style="margin-right: 0.75rem; padding: 0.375rem; color: #818181; border-radius: 0.375rem;"
                ...
                <h1 style="font-size: 1.25rem; font-weight: 700; color: #e3e3e3;">Nova Cotação</h1>
            </div>
                        ...
                        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 0.875rem;">
                            ...
                            <div style="grid-column: span 2;">
                                ...
                                <div style="display: flex; gap: 1rem; margin-bottom: 0.5rem;">
                                    <label style="display: flex; align-items: center; cursor: pointer; font-size: 0.875rem; color: #a4a4a4;">
                                ...
                                <div x-show="productType === 'existing'" style="position: relative;">
                                    ...
                                    <div x-show="showResults && searchResults.length > 0" @click.away="showResults = false"
                                         style="position: absolute; z-index: 10; width: 100%; margin-top: 0.25rem; background: #141414; border: 1px solid rgba(255,255,255,0.06); border-radius: 0.375rem; box-shadow: 0 4px 6px rgba(0,0,0,0.1); max-height: 12rem; overflow: auto;">
                                        <template x-for="product in searchResults" :key="product.id">
                                            <div @click="selectProduct(product)" style="padding: 0.5rem 0.75rem; cursor: pointer; font-size: 0.875rem;"
                                                ...
                                                <div style="font-weight: 500; color: #e3e3e3;" x-text="product.name"></div>
                                                <div style="font-size: 0.75rem; color: #818181;" x-text="'SKU: ' + product.sku"></div>
                                            </div>
                                        </template>
                                    </div>
                                </div>
                            ...
                            <div>
                                <label style="display: block; font-size: 0.75rem; font-weight: 500; color: #818181; margin-bottom: 0.25rem;">
                                    Preço Unitário <span style="color: #fca5a5;">*</span>
                                </label>
                                <div style="position: relative;">
                                    <span style="position: absolute; left: 0.625rem; top: 50%; transform: translateY(-50%); color: #818181; font-size: 0.75rem;">R$</span>
                                    <input type="number" name="unit_price" value="{{ old('unit_price') }}" step="0.01" min="0.01" required
                                           style="width: 100%; padding: 0.5rem 0.625rem 0.5rem 2rem; background: #1a1a1a; color: #e3e3e3; border: 1px solid rgba(255,255,255,0.08); border-radius: 0.375rem; font-size: 0.875rem;">
                                </div>
                            </div>
