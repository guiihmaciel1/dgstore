<x-app-layout>
    <x-slot name="title">Novo Pedido de Importação</x-slot>
    <div class="py-4">
        <div class="px-6 lg:px-8">
            ...
            <div style="display: flex; align-items: center; margin-bottom: 1.5rem;">
                <a href="{{ route('imports.index') }}" style="margin-right: 1rem; padding: 0.5rem; color: #818181; border-radius: 0.5rem;"
                ...
                <div>
                    <h1 style="font-size: 1.5rem; font-weight: 700; color: #e3e3e3;">Novo Pedido de Importação</h1>
                    <p style="font-size: 0.875rem; color: #818181;">Registre um novo pedido de produtos importados</p>
                </div>
            </div>

            <!-- Aviso financeiro -->
            <div style="display: flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1rem; background: rgba(59,130,246,0.1); border: 1px solid #bfdbfe; border-radius: 0.625rem; margin-bottom: 1.25rem; font-size: 0.8rem; color: #93c5fd;">
            ...
            <form method="POST" action="{{ route('imports.store') }}" x-data="importOrderForm()" @submit="submitting = true">
                ...
                <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 1.5rem;">
                    ...
                    <div>
                        ...
                        <div style="background: #141414; border-radius: 0.75rem; border: 1px solid rgba(255,255,255,0.06); overflow: hidden; margin-bottom: 1.5rem;">
                            <div style="padding: 1rem; border-bottom: 1px solid rgba(255,255,255,0.06);">
                                <h3 style="font-weight: 600; color: #e3e3e3;">Informações do Pedido</h3>
                            </div>
                            <div style="padding: 1.25rem;">
                                <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1rem;">
                                    <div>
                                        <label style="display: block; font-size: 0.875rem; font-weight: 500; color: #a4a4a4; margin-bottom: 0.5rem;">Fornecedor</label>
                                        <select name="supplier_id" style="width: 100%; padding: 0.625rem 0.75rem; border: 2px solid rgba(255,255,255,0.08); border-radius: 0.5rem; font-size: 0.875rem; background: #141414;">
                                    ...
                                    <div>
                                        <label style="display: block; font-size: 0.875rem; font-weight: 500; color: #a4a4a4; margin-bottom: 0.5rem;">Data do Pedido *</label>
                                    ...
                                    <div>
                                        <label style="display: block; font-size: 0.875rem; font-weight: 500; color: #a4a4a4; margin-bottom: 0.5rem;">Código de Rastreio</label>
                                        <input type="text" name="tracking_code" value="{{ old('tracking_code') }}" placeholder="Ex: LX123456789CN"
                                               style="width: 100%; padding: 0.625rem 0.75rem; background: #1a1a1a; color: #e3e3e3; border: 2px solid rgba(255,255,255,0.08); border-radius: 0.5rem; font-size: 0.875rem;">
                                    </div>
                                    <div>
                                        <label style="display: block; font-size: 0.875rem; font-weight: 500; color: #a4a4a4; margin-bottom: 0.5rem;">Previsão de Chegada</label>
                                ...
                                <div style="margin-top: 1rem;">
                                    ...
                                    <textarea name="notes" rows="2" placeholder="Notas adicionais sobre o pedido..."
                                              style="width: 100%; padding: 0.625rem 0.75rem; border: 2px solid rgba(255,255,255,0.08); border-radius: 0.5rem; font-size: 0.875rem; resize: vertical;">{{ old('notes') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="background: #141414; border-radius: 0.75rem; border: 1px solid rgba(255,255,255,0.06); overflow: hidden;">
                            <div style="padding: 1rem; border-bottom: 1px solid rgba(255,255,255,0.06); display: flex; justify-content: space-between; align-items: center;">
                                <h3 style="font-weight: 600; color: #e3e3e3;">Itens do Pedido</h3>
                            ...
                            <div style="padding: 1.25rem;">
                                <template x-for="(item, index) in items" :key="index">
                                    <div style="padding: 1rem; background: #1a1a1a; border-radius: 0.5rem; margin-bottom: 0.75rem; border: 1px solid rgba(255,255,255,0.06);">
                                        <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 0.75rem;">
                                            <span style="font-size: 0.75rem; font-weight: 600; color: #818181; text-transform: uppercase;" x-text="'Item ' + (index + 1)"></span>
                                            <button type="button" @click="removeItem(index)" x-show="items.length > 1"
                                                    style="padding: 0.25rem; color: #fca5a5; border-radius: 0.25rem; border: none; background: none; cursor: pointer;"
                                                    title="Remover item">
                                                <svg style="width: 1rem; height: 1rem;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div style="margin-bottom: 0.75rem; position: relative;">
                                            <label style="display: block; font-size: 0.75rem; color: #818181; margin-bottom: 0.25rem;">Produto / Descrição *</label>
                                            ...
                                            <div x-show="item.showSuggestions && item.suggestions.length > 0" x-cloak
                                                 style="position: absolute; top: 100%; left: 0; right: 0; background: #141414; border: 1px solid rgba(255,255,255,0.06); border-radius: 0.375rem; box-shadow: 0 10px 25px rgba(0,0,0,0.1); z-index: 50; max-height: 200px; overflow-y: auto; margin-top: 2px;">
                                                <template x-for="(sug, si) in item.suggestions" :key="si">
                                                    <button type="button" @click="selectSuggestion(index, sug)"
                                                            style="width: 100%; padding: 0.5rem 0.75rem; text-align: left; border: none; background: none; cursor: pointer; border-bottom: 1px solid rgba(255,255,255,0.04); font-size: 0.8125rem;"
                                                            onmouseover="this.style.background='rgba(255,255,255,0.03)'" onmouseout="this.style.background='none'">
                                                        <div style="display: flex; justify-content: space-between; align-items: center;">
                                                            <span x-text="sug.name" style="font-weight: 500; color: #e3e3e3;"></span>
                                                            <span x-show="sug.source === 'quotation'" style="font-size: 0.6875rem; padding: 0.0625rem 0.375rem; background: rgba(59,130,246,0.15); color: #93c5fd; border-radius: 9999px; font-weight: 600;">Cotação</span>
                                                            <span x-show="sug.source === 'product'" style="font-size: 0.6875rem; padding: 0.0625rem 0.375rem; background: #222222; color: #818181; border-radius: 9999px; font-weight: 600;">Produto</span>
                                                        </div>
                                                        <div x-show="sug.price_usd" style="font-size: 0.75rem; color: #16a34a; margin-top: 0.125rem;">
                                                            ...
                                                            <span x-show="sug.supplier" x-text="' — ' + sug.supplier" style="color: #818181;"></span>
                                                        </div>
                                                    </button>
                                                </template>
                                            </div>
                                        ...
                                        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 0.75rem;">
                                            <div>
                                                <label style="display: block; font-size: 0.75rem; color: #818181; margin-bottom: 0.25rem;">Quantidade *</label>
                                                <input type="number" x-model.number="item.quantity" :name="'items[' + index + '][quantity]'" required min="1"
                                                       @input="calculateTotals()"
                                                       style="width: 100%; padding: 0.5rem 0.625rem; background: #1a1a1a; color: #e3e3e3; border: 1px solid rgba(255,255,255,0.08); border-radius: 0.375rem; font-size: 0.875rem;">
                                            </div>
                                            <div>
                                                <label style="display: block; font-size: 0.75rem; color: #818181; margin-bottom: 0.25rem;">
                                                    Cotação (USD)
                                                    <span style="font-size: 0.625rem; color: #666666;" title="Preço da última cotação cadastrada">?</span>
                                                </label>
                                                <input type="text" :value="item.quoted_price ? ('$ ' + item.quoted_price.toFixed(2).replace('.', ',')) : '—'" readonly
                                                       style="width: 100%; padding: 0.5rem 0.625rem; border: 1px solid rgba(255,255,255,0.06); border-radius: 0.375rem; font-size: 0.875rem; background: #1a1a1a; color: #818181;">
                                            </div>
                                            <div>
                                                <label style="display: block; font-size: 0.75rem; color: #818181; margin-bottom: 0.25rem;">
                                                    Custo Pago (USD) *
                                                    <span style="font-size: 0.625rem; color: #666666;" title="Valor que você realmente pagou">?</span>
                                                </label>
                                        ...
                                        <!-- Subtotal do item -->
                                        <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 0.5rem; padding-top: 0.5rem; border-top: 1px solid rgba(255,255,255,0.06);">
                                            <!-- Desconto badge -->
                                            <div>
                                                <template x-if="item.quoted_price && item.unit_cost > 0 && item.unit_cost < item.quoted_price">
                                                    <span style="font-size: 0.6875rem; padding: 0.125rem 0.5rem; background: rgba(16,185,129,0.15); color: #16a34a; border-radius: 9999px; font-weight: 600;"
                                                ...
                                                <template x-if="item.quoted_price && item.unit_cost > item.quoted_price">
                                                    <span style="font-size: 0.6875rem; padding: 0.125rem 0.5rem; background: rgba(239,68,68,0.1); color: #fca5a5; border-radius: 9999px; font-weight: 600;"
                                                          x-text="'+' + (((item.unit_cost - item.quoted_price) / item.quoted_price) * 100).toFixed(0) + '% acima'"></span>
                                                </template>
                                            </div>
                                            <div style="text-align: right; font-size: 0.8125rem; color: #818181;">
                                                Subtotal: <span style="font-weight: 600; color: #e3e3e3;" x-text="'$ ' + (item.quantity * item.unit_cost).toFixed(2).replace('.', ',')"></span>
                                                <span style="color: #666666; margin-left: 0.375rem;" x-text="'(R$ ' + (item.quantity * item.unit_cost * exchangeRate).toFixed(2).replace('.', ',') + ')'"></span>
                                            </div>
                                        </div>
                                    </div>
                                </template>

                                <div x-show="items.length === 0" style="padding: 2rem; text-align: center; color: #818181;">
                    ...
                    <div>
                        <div style="background: #141414; border-radius: 0.75rem; border: 1px solid rgba(255,255,255,0.06); overflow: hidden; position: sticky; top: 1rem;">
                            <div style="padding: 1rem; border-bottom: 1px solid rgba(255,255,255,0.06);">
                                <h3 style="font-weight: 600; color: #e3e3e3;">Custos e Conversão</h3>
                            </div>
                            <div style="padding: 1.25rem;">
                                <!-- Cotação USD/BRL -->
                                <div style="margin-bottom: 1rem;">
                                    <label style="display: block; font-size: 0.875rem; font-weight: 500; color: #a4a4a4; margin-bottom: 0.5rem;">Cotação USD/BRL *</label>
                                    <input type="number" name="exchange_rate" x-model.number="exchangeRate" required min="0.01" step="0.0001"
                                           @input="calculateTotals()"
                                           style="width: 100%; padding: 0.625rem 0.75rem; background: #1a1a1a; color: #e3e3e3; border: 2px solid rgba(255,255,255,0.08); border-radius: 0.5rem; font-size: 0.875rem;">
                                    <div style="margin-top: 0.25rem; font-size: 0.6875rem; color: #818181;" x-show="dailyRate > 0">
                                ...
                                <div style="margin-bottom: 1rem;">
                                    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 0.5rem;">
                                        <label style="font-size: 0.875rem; font-weight: 500; color: #a4a4a4;">Frete</label>
                                        <div style="display: flex; background: #222222; border-radius: 0.375rem; overflow: hidden; border: 1px solid rgba(255,255,255,0.06);">
                                            <button type="button" @click="shippingMode = 'value'; calculateTotals()"
                                                    :style="shippingMode === 'value' ? 'background: #111827; color: white;' : 'background: transparent; color: #818181;'"
                                            ...
                                            <button type="button" @click="shippingMode = 'percent'; calculateTotals()"
                                                    :style="shippingMode === 'percent' ? 'background: #111827; color: white;' : 'background: transparent; color: #818181;'"
                                    ...
                                    <div style="position: relative;">
                                        <input type="number" x-model.number="shippingInput" min="0" step="0.01"
                                               ...
                                               style="width: 100%; padding: 0.625rem 0.75rem; background: #1a1a1a; color: #e3e3e3; border: 2px solid rgba(255,255,255,0.08); border-radius: 0.5rem; font-size: 0.875rem;">
                                        <span x-show="shippingMode === 'percent'" style="position: absolute; right: 0.75rem; top: 50%; transform: translateY(-50%); font-size: 0.75rem; color: #666666;">% do subtotal</span>
                                    </div>
                                    <input type="hidden" name="shipping_cost" :value="shippingCostFinal.toFixed(2)">
                                    <div x-show="shippingMode === 'percent' && shippingCostFinal > 0" style="margin-top: 0.25rem; font-size: 0.6875rem; color: #818181;">
                                ...
                                <div style="margin-bottom: 1.5rem;">
                                    <label style="display: block; font-size: 0.875rem; font-weight: 500; color: #a4a4a4; margin-bottom: 0.5rem;">
                                        ...
                                        <span style="font-size: 0.625rem; color: #666666;" title="Inclua impostos de importação, taxas alfandegárias e custos de transporte local (TAXI)">?</span>
                                    </label>
                                ...
                                <div style="padding-top: 1rem; border-top: 1px solid rgba(255,255,255,0.06);">
                                    ...
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 1rem; font-size: 0.8125rem;">
                                        <span style="color: #818181;">+ Impostos/Taxas/TAXI:</span>
                                    ...
                                    <div style="display: flex; justify-content: space-between; padding-top: 0.75rem; border-top: 2px solid #111827;">
                                        <span style="font-weight: 700; color: #e3e3e3;">Total Estimado:</span>
                                        <span style="font-weight: 700; color: #e3e3e3; font-size: 1.125rem;" x-text="'R$ ' + totalBrl.toFixed(2).replace('.', ',')"></span>
                                    </div>
                                    <div style="text-align: right; font-size: 0.6875rem; color: #818181; margin-top: 0.25rem;" x-show="items.length > 0 && totalBrl > 0">
