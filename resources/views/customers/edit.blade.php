    ...
    <div class="py-6">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div style="display: flex; align-items: center; margin-bottom: 1.5rem;">
                <a href="{{ route('customers.show', $customer) }}" style="margin-right: 1rem; padding: 0.5rem; color: #6b7280; border-radius: 0.5rem;"
                ...
                <div>
                    <h1 style="font-size: 1.5rem; font-weight: 700; color: #111827;">Editar Cliente</h1>
                    <p style="font-size: 0.875rem; color: #6b7280;">{{ $customer->name }}</p>
                </div>
            </div>
                        ...
                        <div style="display: flex; flex-direction: column; gap: 1.25rem;">
                            ...
                            <div>
                                ...
                                <textarea name="address" rows="2"
                                          ...
                                          onfocus="this.style.borderColor='#111827'" onblur="this.style.borderColor='#e5e7eb'">{{ old('address', $customer->address) }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="notes" rows="3"
                                          style="width: 100%; padding: 0.625rem 0.75rem; border: 2px solid #e5e7eb; border-radius: 0.5rem; font-size: 0.875rem; resize: vertical;"
                                          onfocus="this.style.borderColor='#111827'" onblur="this.style.borderColor='#e5e7eb'">{{ old('notes', $customer->notes) }}</textarea>
                            </div>
                        </div>
                    </div>
