        ...
        <div class="px-6 lg:px-8">
            ...
            <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 1rem;">
                <div style="display: flex; align-items: center;">
                    <a href="{{ route('products.show', $product) }}" style="margin-right: 0.75rem; padding: 0.375rem; color: #818181; border-radius: 0.375rem;"
                    ...
                    <div>
                        <h1 style="font-size: 1.25rem; font-weight: 700; color: #e3e3e3;">Editar Produto</h1>
                        <p style="font-size: 0.75rem; color: #818181;">{{ Str::limit($product->name, 50) }}</p>
                    </div>
                </div>
            </div>
